...
<meta name="description" content="Download ${name} Episode ${ep}">
...
.poster-wrap{position:relative;margin-bottom:28px;animation:su .5s ease-out}
...
.ep-badge{display:inline-flex;align-items:center;gap:7px;background:rgba(124,58,237,0.2);border:1px solid rgba(124,58,237,0.3);color:#c084fc;font-size:12px;font-weight:700;padding:7px 16px;border-radius:30px;margin-bottom:16px;backdrop-filter:blur(10px);animation:su .5s ease-out .1s both}
.title{font-size:24px;font-weight:800;text-align:center;line-height:1.25;margin-bottom:6px;text-shadow:0 4px 30px rgba(0,0,0,0.6);animation:su .5s ease-out .15s both}
.meta{font-size:13px;color:rgba(255,255,255,0.4);margin-bottom:36px;display:flex;align-items:center;gap:12px;animation:su .5s ease-out .2s both}
...
.dl-btn{display:flex;align-items:center;gap:14px;width:100%;padding:18px 22px;border-radius:16px;font-size:15px;font-weight:700;text-decoration:none;transition:all .3s;margin-bottom:12px;position:relative;overflow:hidden}
.dl-btn:active{transform:scale(0.98)}
.dl-btn.sub{background:linear-gradient(135deg,#7c3aed,#a855f7);color:#fff;box-shadow:0 8px 32px rgba(124,58,237,0.4)}
.dl-btn.sub:hover{transform:translateY(-3px);box-shadow:0 14px 44px rgba(124,58,237,0.5)}
.dl-btn.dub{background:rgba(255,255,255,0.04);color:#fff;border:1px solid rgba(255,255,255,0.08)}
...
@keyframes su{from{opacity:0;transform:translateY(25px)}to{opacity:1;transform:translateY(0)}}
